...
import az.ingress.announcementmanagementsystem.mapper.AnnouncementMapper;
import az.ingress.announcementmanagementsystem.repository.AnnouncementDetailRepository;
import az.ingress.announcementmanagementsystem.repository.AnnouncementRepository;
...
import az.ingress.announcementmanagementsystem.specification.AnnouncementSpecification;
...
import static az.ingress.announcementmanagementsystem.enums.ExceptionMessage.ANNOUNCEMENT_DETAILS_NOT_FOUND;
import static az.ingress.announcementmanagementsystem.enums.ExceptionMessage.ANNOUNCEMENT_NOT_FOUND;
import static az.ingress.announcementmanagementsystem.enums.ExceptionMessage.USER_NOT_FOUND;
import static az.ingress.announcementmanagementsystem.mapper.PageableMapper.mapAnnouncementResponsePageToCustomPageResponse;
import static az.ingress.announcementmanagementsystem.util.AnnouncementUtil.checkUserLogin;
import static az.ingress.announcementmanagementsystem.util.AnnouncementUtil.getDefaultPageable;
...
public class AnnouncementServiceImpl implements AnnouncementService {
    ...
    public AnnouncementResponse deleteAnnouncement(Long announcementId) {
        ...
        checkUserLogin(announcement.getUser());
